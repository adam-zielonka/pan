...
const CardElement: React.FC<{ card: Card, disabled: boolean }> = ({ card, disabled }) => {
...
const PlayerElement: React.FC<{ player: IPlayer, id: number, isStackEmpty: boolean }> = ({ player, id, isStackEmpty }) => {
